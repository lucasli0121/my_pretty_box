...
import com.effectsar.labcv.resource.BaseResource;
import com.effectsar.labcv.resource.ResourceManager;
import com.effectsar.labcv.resource.RemoteResource;
import com.effectsar.labcv.resource.network.NetworkManager;
...
public class StickerFetch implements BaseResource.ResourceListener {
    public static final String BASE_URL_PROD = "https://assets.voleai.com";
    public static final String BASE_URL_BOE = "http://sticker-distribution.bytedance.net";
    public static String BASE_URL = BASE_URL_PROD;

    private RemoteResource mResource;
    private FetchListener mListener;
    private StickerPage mLocalStickerPage;
