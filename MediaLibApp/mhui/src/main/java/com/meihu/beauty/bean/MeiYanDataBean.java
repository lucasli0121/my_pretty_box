...
public class MeiYanDataBean {
    ...
    public boolean getTieZhiIsAction() {
        return tieZhiIsAction;
    }

    public void setTieZhiIsAction(boolean tieZhiIsAction) {
        this.tieZhiIsAction = tieZhiIsAction;
    }

    public String  getTieZhiKey() {
        return tieZhiKey;
    }

    public void setTieZhiKey(String tieZhiKey) {
        this.tieZhiKey = tieZhiKey;
    }
    ...
    public boolean getHahaTeXiao() {
        return hahaTeXiao;
    }

    public void setHahaTeXiao(boolean hahaTeXiao) {
        this.hahaTeXiao = hahaTeXiao;
    }
