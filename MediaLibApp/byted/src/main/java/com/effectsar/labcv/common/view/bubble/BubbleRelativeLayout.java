...
public class BubbleRelativeLayout extends RelativeLayout {
    ...
    public static int SHADOW_COLOR = Color.argb(128, 0, 0, 0);
    public static int FILL_COLOR = Color.argb(128, 0, 0, 0);
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                PADDING = a.getDimensionPixelSize(R.styleable.bubble_bubble_padding, PADDING);
                SHADOW_COLOR = a.getInt(R.styleable.bubble_bubble_shadowColor, SHADOW_COLOR);
                LEG_HALF_BASE = a.getDimensionPixelSize(R.styleable.bubble_bubble_halfBaseOfLeg, LEG_HALF_BASE);
                MIN_LEG_DISTANCE = PADDING + LEG_HALF_BASE;
                STROKE_WIDTH = a.getFloat(R.styleable.bubble_bubble_strokeWidth, STROKE_WIDTH);
                CORNER_RADIUS = a.getFloat(R.styleable.bubble_bubble_cornerRadius, CORNER_RADIUS);
            } finally {
                if (a != null) {
                    a.recycle();
                }
        ...
        mFillPaint.setShader(new LinearGradient(100f, 0f, 100f, 200f, FILL_COLOR, FILL_COLOR, TileMode.CLAMP));
     ...
     */
    /** {en} 
     * According to the display direction, get the sharp angle position matrix
     * @param width
     * @param height
     * @return
     */
