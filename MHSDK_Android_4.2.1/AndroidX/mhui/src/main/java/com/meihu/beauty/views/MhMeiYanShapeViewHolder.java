...
//            valueBean.setKaiYanJiao(0);
            ...
            valueBean.setDaYan(0);
            valueBean.setMeiMao(50);
            valueBean.setYanJu(50);
            valueBean.setYanJiao(50);
            valueBean.setShouLian(0);
            valueBean.setZuiXing(50);
            valueBean.setShouBi(50);
            valueBean.setXiaBa(50);
            valueBean.setETou(50);
            valueBean.setChangBi(50);
            valueBean.setXueLian(0);
            valueBean.setKaiYanJiao(50);
