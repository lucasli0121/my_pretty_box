package com.effectsar.labcv.common.mediapicker;
...
import com.effectsar.labcv.common.mediapicker.PickerConfig;
...
public class TakePhotoActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        intent.putParcelableArrayListExtra(com.effectsar.labcv.common.mediapicker.PickerConfig.EXTRA_RESULT, medias);
